...
# Przewodnik dla studentów: Jak zaangażować się w projekt ONNX

## Witaj w społeczności ONNX! 

Ten dokument pomoże Ci zrobić pierwsze kroki w kontrybuowaniu do projektu open source. Nie martw się, jeśli to Twoje pierwsze doświadczenie - każdy kiedyś zaczynał!

## Ścieżki zaangażowania - Znajdź swoją rolę

ONNX to projekt społecznościowy oferujący wiele sposobów współpracy, nie tylko przez pisanie kodu:
